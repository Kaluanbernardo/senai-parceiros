...
const PROVIDER_SELECTION = ['AI_PROVIDER', 'OPENROUTER_MODEL', 'OPENAI_MODEL', 'RADAR_SUMMARY_PROVIDER', 'RADAR_EDITORIAL_PROVIDER', 'RADAR_EDITORIAL_MAX_ITEMS', 'RADAR_EDITORIAL_DEADLINE_MS'];

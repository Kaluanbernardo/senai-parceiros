...
export const RADAR_WEB_POLICY = [
  ...
  { name: 'CEE-SP', section: 'government', url: 'https://www.ceesp.sp.gov.br/noticias', official: true, geography: 'São Paulo' },
  { name: 'SEADE', section: 'government', url: 'https://www.seade.gov.br/noticias/', official: true, geography: 'São Paulo' },
  { name: 'InvestSP', section: 'government', url: 'https://investsp.org.br/noticias/', official: true, geography: 'São Paulo' },

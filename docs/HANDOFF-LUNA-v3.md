...
- O preflight executável `npm run handoff:preflight:corporate` verifica provider, Entra, origem, stores duráveis/atômicos, alertas, cron, feeds e IA sem imprimir segredos; deve ser o primeiro gate após preencher o ambiente corporativo.

...
> Para a entrega atual, priorize o MVP publico e valide `npm run handoff:preflight:mvp`. A configuracao Azure/Entra e o preflight corporativo sao trilhas futuras de migracao, nao bloqueios para o MVP.

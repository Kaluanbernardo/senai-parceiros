...
export function generateResearchPrompt({ category, context, purpose, geography, quantity, extraCriteria, columns }) {
  ...
  const sections = [
    ...
    '',
    'SAÍDA OBRIGATÓRIA',
    'Entregue um workbook XLSX com as abas Stakeholders e Metadados. Se a ferramenta não conseguir gerar XLSX, entregue um CSV UTF-8 com a tabela Stakeholders, usando os mesmos nomes, ordem e tipos de colunas. Ambos os formatos podem ser importados diretamente.',
    '',

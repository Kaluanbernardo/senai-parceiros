...
const CATEGORIES = [
  { path: '/catalogo/pesquisadores', label: 'Pesquisadores', description: 'Especialistas e autores ligados a EPT, VET e desenvolvimento industrial.', icon: <ScienceIcon />, themeKey: 'catalog' },
  { path: '/catalogo/escolas', label: 'Escolas', description: 'Instituições de educação profissional e redes de formação.', icon: <SchoolIcon />, themeKey: 'catalog' },
  { path: '/catalogo/organizacoes', label: 'Organizações', description: 'Empresas, órgãos públicos e outras instituições relevantes.', icon: <BusinessIcon />, themeKey: 'catalog' },
];
